...
export async function POST(req: Request) {
  try {
    ...
    if (resend) {
      ...
      console.log(`Skipped shipping email to ${email} because RESEND_API_KEY is missing`);
    }

    return NextResponse.json({ success: true, message: "Webhook processed completely" });
