      ...
      <SheetContent className="sm:max-w-lg w-[90vw]">
        ...
        <div className="h-full flex flex-col justify-between">
          <div className="flex-1 mt-8 overflow-y-auto">
            {cartCount === 0 ? (
              <h1 className="text-gray-900 py-6">You dont have any products in the cart</h1>
            ) : (
              <>
                    ...
                    <li key={entry.id} className="flex py-6">
                      ...
                      <div className="ml-4 flex flex-1 flex-col">
                        <div>
                          ...
                          <p className="mt-1 text-sm text-gray-500">Size: {entry.size}</p>
                        </div>
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
              <p>
                OR <button type="button" onClick={() => handleCartClick()} className="font-medium text-primary hover:text-primary/80">Continue Shopping</button>
              </p> 
            </div>
          </div>
        </div>
